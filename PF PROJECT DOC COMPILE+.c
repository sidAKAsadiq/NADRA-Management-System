...
void nic()
{
	char name[30],fathername[30],gender[8],identitynumber[30],dateofbirth[12],country[50],religion[20],address[30],birthmark[20],issuedate[12];
			FILE *nicp=NULL;
			nicp=fopen("D:/C practice/sample1.txt","a");
			printf("Name: ");
			fflush(stdin);
			gets(name);
			...
			fprintf(nicp,"_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _\n");
			fprintf(nicp,"Name: %s",name);//puts(name);
			fprintf(nicp,"\n");
			fprintf(nicp,"Father's name:%s ",fathername);
			//puts(fathername);
			fprintf(nicp,"\n");
			fprintf(nicp,"Gender: %s",gender);
			//puts(gender);
			fprintf(nicp,"\n");
			fprintf(nicp,"identity number:%s ",identitynumber);
			//puts(identitynumber);
			fprintf(nicp,"\n");
			fprintf(nicp,"Date of birth:%s ",dateofbirth);
			//puts(dateofbirth);
			fprintf(nicp,"\n");
			fprintf(nicp,"Nationality:%s ",country);
			//puts(country);
			fprintf(nicp,"\n");
			fprintf(nicp,"Religion:%s ",religion);
			//puts(religion);
			fprintf(nicp,"\n");
			fprintf(nicp,"Permanent Address: %s",address);
			//puts(address);
			fprintf(nicp,"\n");
			fprintf(nicp,"Date of issue:%s ",issuedate);
			//puts(dateofbirth);
			fprintf(nicp,"\n");
		    fprintf(nicp,"Birth Mark:%s ",birthmark);
			//puts(birthmark);
		    fprintf(nicp,"\n\n");
		    fprintf(nicp,"_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _\n");
